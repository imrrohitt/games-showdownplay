...
<body>
    <div class="container">
        ...
        <div class="form-section">
            ...
            <p style=" margin-top:30px;">Don't have an account? <a style="color: rgb(212, 158, 22); font-weight: 900" href="register_html.php">Register here</a></p>
        </div>
    </div>
